	...
	var ping = function () {
		...
		$.ajax({
			...
			success: function(rain_barrel) {
				...
				// $("li a").hover(function() {
				// 	// console.log(" : " + $(this).hasClass('fl-link'));
				// 	if ($(this).hasClass('fl-link')) { // filter life animation
				// 		console.log(" : " + $(this).hasClass('fl-link'));
				...
				// $('#nav_list li a').on('hover', function() {
				// 	console.log("HELLO");
				...
				// 		});
				// 	} else if ($(this).hasClass('wq-link')) { // water quality animations
				// 		$(".pH-bar").animate({
				// 			top: wq_ph_top_target + "%",
				// 			height: wq_ph_height_target + "px",
				// 		}, 2000, function() {
				...
				// 		});
				// 	} else if ($(this).hasClass('wl-link')) { // water level animation
				// 		$("#water_level").animate({
				// 			top: wl_top_target + "%",
				// 			height: wl_height_target + "px",
				// 		}, 1000, function() {
...
function draw(w, h, margin, barWidth, user_id, view) {
  ...
  function sendAjaxRequest(time, metric) {
    return $.ajax({ url: "/users/" + user_id +"/workouts/analyze.json", data: { metric: metric, time: time }, dataType: "json" }); 
  } 
...
$(document).on('ready page:load', function () {	
	...
	if ($(".usage-section").length == 1) { draw(900, 360, margin, 25, user_id, view); }		
}); 
